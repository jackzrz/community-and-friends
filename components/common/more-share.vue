<template>
	<uni-popup ref="popup" type="bottom" class="bg-white">
		<view class="text-center py-2 font-md border-bottom bg-white" hover-class="bg-light">分享到</view>
		<view class="flex align-center bg-white ">
			<view class=" py-3 flex-1 flex flex-column align-center justify-center" v-for="(item,index) in providerList"
				:key="index" hover-class="bg-light" @tap="share(item)">
				<view
					class="rounded-circle iconfont icon-QQ bg-primary text-white flex align-center justify-center font-lg"
